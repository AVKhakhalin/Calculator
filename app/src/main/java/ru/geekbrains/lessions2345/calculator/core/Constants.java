...
public interface Constants {
    ...
    enum FUNCTIONS {
        ...
        // TODO: сюда можно дописать другие функции
        //  sin, cos, tang, exp, log, факториал (!) и т.д. *!*
    }
    ...
    enum ERRORS_INPUTTING {
        ...
        PERCENT_NEEDS_TWO_NUMBERS_OUT_BRACKET, // для применения процента после скобки
        ...
        CLOSE_BRACKET_ON_EMPTY_OPEN_BRACKET, // нельзя поставить закрывающую скобку, если
                                    ...
                                    // открывающую скобку
        CLOSE_BRACKET_ON_EMPTY,     // нельзя ставить закрывающую скобку, если в скобке ничего нет,
